                ...
                <div className="row">
                    ...
                    <div className="col-md-6 section-title sal-animate">
                        ...
                        <div className="read-more-btn mt--30 sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                            <a className="edu-btn" href="/about-us">Know About Us <i class="icon-arrow-right-line-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="edu-accordion edu-accordion-02 sal-animate" id="accordionExample1" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                        <div class="edu-accordion-item">
                                            <div class="edu-accordion-header" id="headingOne">
                                                <button class="edu-accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                                <i class="ri-computer-line"></i>  Compute Services
                                                </button>
                                            </div>
                                        ...
                                        <div class="edu-accordion-item">
                                            <div class="edu-accordion-header" id="headingTwo">
                                                ...
                                                <i class="ri-database-2-line"></i> Database Services
                                                </button>
                                            </div>
                                        ...
                                        <div class="edu-accordion-item">
                                            <div class="edu-accordion-header" id="headingThree">
                                                ...
                                                <i class="ri-printer-cloud-line"></i>  Networking
                                                </button>
                                            </div>
                                        ...
                                        <div class="edu-accordion-item">
                                            <div class="edu-accordion-header" id="heading10">
                                                <button class="edu-accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse10" aria-expanded="false" aria-controls="collapse10">
                                                <i class="ri-git-repository-private-line"></i>   Security and Identity
                                                </button>
                                            </div>
                            ...
                            <div className="col-md-6">
                                <div class="accordion-style-1">
                                    <div class="edu-accordion edu-accordion-02 sal-animate" id="accordionExample2" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                        ...
                                        <div class="edu-accordion-item">
                                            <div class="edu-accordion-header" id="heading11">
                                                <button class="edu-accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse11" aria-expanded="false" aria-controls="collapse11">
                                                <i class="ri-tools-line"></i>  Management Tools
                                                </button>
                                            </div>
                                        ...
                                        <div class="edu-accordion-item">
                                            <div class="edu-accordion-header" id="headingFour">
                                                ...
                                                <i class="ri-lightbulb-line"></i> Machine Learning and AI
                                                </button>
                                            </div>
                                        ...
                                        <div class="edu-accordion-item">
                                            <div class="edu-accordion-header" id="heading9">
                                                <button class="edu-accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse9" aria-expanded="false" aria-controls="collapse9">
                                                <i class="ri-slideshow-line"></i> Analytics
                                                </button>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="section-title  sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                        ...
                                        <h3 class="title">The Importance of <br />Amazon Web Services</h3>
                                ...
                                <div class="col-lg-4 col-md-6 col-12 sal-animate" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                                    <div class="service-card service-card-3 text-left shape-bg-2">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h6 class="title"><a href="#">Cost-Efficiency</a></h6>
                                                <p class="description">
                                ...
                                <div class="col-lg-4 col-md-6 col-12 sal-animate" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                                    <div class="service-card service-card-3 text-left shape-bg-3">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h6 class="title"><a href="#">Global Reach</a></h6>
                                                <p class="description">Amazon Web Services (AWS) boasts an extensive global infrastructure, featuring data centers located in multiple regions around the world. This allows businesses to deploy applications globally, reducing latency and ensuring a better experience
                                ...
                                <div class="col-lg-4 col-md-6 col-12 sal-animate" data-sal-delay="300" data-sal="slide-up" data-sal-duration="800">
                                    <div class="service-card service-card-3 text-left shape-bg-4">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h6 class="title"><a href="#">Reliability and Redundancy</a></h6>
                                                <p class="description">
                                ...
                                <div class="col-lg-4 col-md-6 col-12 sal-animate" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                                    <div class="service-card service-card-3 text-left shape-bg-3">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h6 class="title"><a href="#">Security and Compliance</a></h6>
                                                <p class="description">
                                ...
                                <div class="col-lg-4 col-md-6 col-12 sal-animate" data-sal-delay="300" data-sal="slide-up" data-sal-duration="800">
                                    <div class="service-card service-card-3 text-left shape-bg-4">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h6 class="title"><a href="#">Innovation and Rapid Deployment</a></h6>
                                                <p class="description">
                                ...
                                <div class="col-lg-4 col-md-6 col-12 sal-animate" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                                    <div class="service-card service-card-3 text-left shape-bg-3">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h6 class="title"><a href="#">Diverse Service Portfolio</a></h6>
                                                <p class="description">
                                ...
                                <div class="col-lg-4 col-md-6 col-12 sal-animate" data-sal-delay="300" data-sal="slide-up" data-sal-duration="800">
                                    <div class="service-card service-card-3 text-left shape-bg-4">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h6 class="title"><a href="#">Serverless Computing</a></h6>
                                                <p class="description">
                                ...
                                <div class="col-lg-4 col-md-6 col-12 sal-animate" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                                    <div class="service-card service-card-3 text-left shape-bg-3">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h6 class="title"><a href="#">Big Data and Analytics</a></h6>
                                                <p class="description">
                                ...
                                <div class="col-lg-4 col-md-6 col-12 sal-animate" data-sal-delay="300" data-sal="slide-up" data-sal-duration="800">
                                    <div class="service-card service-card-3 text-left shape-bg-4">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h6 class="title"><a href="#">Community and Ecosystem</a></h6>
                                                <p class="description">
                                ...
                                <div class="col-lg-4 col-md-6 col-12 sal-animate" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                                    <div class="service-card service-card-3 text-left shape-bg-3">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h6 class="title"><a href="#">Disaster Recovery and Business Continuity</a></h6>
                                                <p class="description">
                    ...
                    <div class="col-lg-7 order-2 order-lg-1">
                        <div class="workshop-inner">
                            <div class="section-title text-white sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                <span class="pre-title">What Does An </span>
                                <h3 class="title">AWS Engineer Do?</h3>
                            </div>
...
An AWS engineer is a versatile professional who combines technical expertise with strategic thinking to design, implement, and manage AWS solutions that meet the evolving needs of businesses in terms of scalability, security, and performance.
                    ...
                    <div class="col-lg-5 order-1 order-lg-2">
                        <div class="thumbnail video-popup-wrapper">
                            <img class="radius-small w-100" src={amozoncloud} alt="About Image"/>                           
                        </div>
                    </div>
                </div>
